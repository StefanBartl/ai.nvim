...
---@field provider_order? string[] `"auto"` resolution order (default `{"claude","ollama","openai"}`) -- deliberately never includes `"loomai"`; see `ai.providers`'s module doc for why
